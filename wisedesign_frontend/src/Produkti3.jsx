...
import img1 from "./images/IMG_7273.jpg";
import img2 from "./images/IMG_7275.jpg";
import img3 from "./images/IMG_7279.jpg";
import {Link} from 'react-router-dom';
import cartIcon from "./images/cartIcon.png";

const Produkti3 = ({ addToCart }) => {
  const product = {
    id: 3,
    name: "Stickers",
    price: 20,
    ...
    <div>
      ...
      <Container className="mt-5">
        ...
        <Row className="align-items-center">
          ...
          <Col md={6}>
            <p>
              Shtoni një prekje unike paketimit të produkteve tuaja me stickers të personalizuara me logon, sloganin ose dizajnin tuaj. Ideale për të rritur identitetin e markës dhe për të lënë një përshtypje të paharrueshme te klientët! 🏷️🚀
            </p>
