...
import img1 from "./images/IMG_7285.jpg";
import img2 from "./images/IMG_6955.jpg";
import img3 from "./images/IMG_7298.jpg";
import {Link} from 'react-router-dom';
import cartIcon from "./images/cartIcon.png";

const Produkti5 = ({ addToCart }) => {
  const product = {
    id: 5,
    name: "Varëse çelësash",
    price: 15, 
    image: {img1},
  };
    ...
    <div>
      ...
      <Container className="mt-5">
        ...
        <Row className="align-items-center">
          ...
          <Col md={6}>
            <p>Personalizo varësen e çelësave me emrin, logon ose një mesazh të veçantë. Ideale si dhuratë unike apo si pjesë e identitetit të biznesit tuaj. Materiale cilësore dhe dizajn kreativ për një prekje personale në çdo detaj! 🎁🚀</p>
