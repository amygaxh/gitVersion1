...
import img1 from "./images/IMG_6961.jpg";
import img2 from "./images/3.jpg";
import img3 from "./images/4.jpg";
import {Link} from 'react-router-dom';
import cartIcon from "./images/cartIcon.png";

const Produkti9 = ({ addToCart }) => {
  const product = {
    id: 9,
    name: "T-Shirt",
    price: 25, 
    ...
    <div>
      ...
      <Container className="mt-5">
        ...
        <Row className="align-items-center">
          ...
          <Col md={6}>
            <p>Personalizo T-shirt-et me foto, mesazhe të veçanta, logo biznesi ose dizajne kreative. Ideale për veshje të personalizuara, dhurata, suvenire apo promovim të markës suaj. Një mundësi perfekte për të shfaqur stilin tuaj unik dhe për të lënë një përshtypje të paharrueshme! 👕🎨🚀</p>
